...
export default function JoinBattle() {
  return (
    <DashboardLayout>
      <Helmet>
        <title>Warfront | Join a Battle</title>
        <meta name="description" content="Online battles are coming soon to Warfront." />
      </Helmet>
      <div className="min-h-[80vh] flex items-center justify-center">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-slate-300 max-w-md mx-auto mb-6">
            Online battles are currently under development. Get ready to deploy your forces!
          </p>
