...
export default function PagesPrivate() {
  ...
  const [rows, setRows] = useState(cmsStore.getByCategory("private"));

  useEffect(() => {
    const sync = () => setRows(cmsStore.getByCategory("private"));
  ...
  return (
    <DashboardLayout>
      <Helmet>
        <title>Admin • Private Pages | Warfront</title>
        <link rel="icon" type="image/png" href="/assets/Logo.png" />
      </Helmet>

      <div className="container mx-auto py-8 text-white">
        <h1 className="text-3xl font-bold text-red-400 mb-6">Private Pages</h1>
        <Card className="bg-slate-900/50 border-red-500/20">
          <CardHeader>
