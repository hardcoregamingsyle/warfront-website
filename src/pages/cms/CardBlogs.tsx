...
export default function CardBlogs() {
  ...
  const cardBlogs = [
    {
      id: "1",
      title: "Advanced Strategies for Tank Cards",
      author: "Admin",
      status: "Published",
    ...
    {
      id: "2", 
      title: "New Card Reveal: Lightning Strike",
      author: "Admin",
      status: "Draft",
  ...
  return (
    <DashboardLayout>
      <Helmet>
        <title>Admin • Card Blogs | Warfront</title>
      ...
      <div className="container mx-auto py-8 text-white">
        ...
        <Card className="bg-slate-900/50 border-red-500/20">
          <CardHeader>
            <CardTitle className="text-red-400">All Card Blog Posts</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              {cardBlogs.length === 0 ? (
                <div className="text-center py-8">
                  <p className="text-slate-400 mb-4">No card blogs found</p>
                  <Button className="bg-red-600 hover:bg-red-700">
                    <Plus className="h-4 w-4 mr-2" />
                    Create Your First Card Blog
                  </Button>
                </div>
              ) : (
