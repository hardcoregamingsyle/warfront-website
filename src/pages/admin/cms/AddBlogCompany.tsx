...
export default function AdminAddBlogCompany() {
  const { user } = useAuth();
  ...
  return (
    <DashboardLayout>
      <Helmet>
        <title>Add Company Content | Warfront Admin</title>
      </Helmet>

      <div className="container mx-auto py-8">
        <h1 className="text-4xl font-bold text-red-400 mb-6">Add Company Content</h1>
        <Card className="bg-slate-900/50 border-red-500/20">
          <CardContent className="pt-6">
            <p className="text-slate-300">Company content creation form coming soon...</p>
          </CardContent>
        </Card>
      </div>
    </DashboardLayout>
